...
class MedicineTest {
	...
	public void insertMedicines() {
		...
		assertNotNull(medicinerepository.findById(80).get());
	} 
	...
	public void getMedicineById() {
		Medicines M = medicinerepository.findByMedicineId(75);
		assertEquals(75, M.getMedicineId());
		
	}
	
	@Test
	public void deleteMedicine() {
		medicinerepository.deleteById(61);
		assertThat(medicinerepository.existsById(62)).isFalse();
	}
	...
	public void updateMedicine() {
		...
		M.setPrice(200);
		medicinerepository.save(M);
		assertNotEquals(500, medicinerepository.findByMedicineId(75).getPrice());
	}
